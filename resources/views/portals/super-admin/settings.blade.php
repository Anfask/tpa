...
<div style="display: flex; flex-direction: column; gap: 1.5rem;">
    ...
    <div class="card" style="display: flex; flex-direction: column; gap: 1.25rem;">
        ...
        <form action="{{ route('super-admin.settings.profile') }}" method="POST" style="display: flex; flex-direction: column; gap: 1rem; margin-top: 0.5rem;">
            @csrf
    ...
    <div class="card" style="display: flex; flex-direction: column; gap: 1.25rem;">
        ...
        <form action="{{ route('super-admin.settings.password') }}" method="POST" style="display: flex; flex-direction: column; gap: 1rem; margin-top: 0.5rem;">
            @csrf
            <div class="form-group">
