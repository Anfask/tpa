...
@section('title', 'Campus Teachers - TPA')
@section('header_title', 'Campus Teachers')
@section('header_subtitle', 'Manage teaching personnel assigned to your campus')

@section('content')
    <div class="grid-cols-3" style="grid-template-columns: 2fr 1fr; gap: 1.5rem;">
        <!-- Teachers List -->
        <div class="card" style="display: flex; flex-direction: column; gap: 1.5rem;">
            <h3>My Campus Teachers</h3>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; gap: 0.5rem;">
                                        <a href="{{ route('admin.teachers.profile', $teacher->id) }}" class="btn-icon"
                                            title="View Profile" style="font-size: 0.9rem;">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" style="text-align: center; color: var(--text-muted); padding: 2rem;">
                                    No teachers assigned to your campus. Add one to get started.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <!-- Right Add/Edit Panel (Restricted to Campus) -->
        <div class="card" style="align-self: flex-start;">
            <h3 id="panel-title" style="margin-bottom: 1.5rem;"><i class="fa-solid fa-user-plus"></i> Add Teacher</h3>

            <form id="teacher-form" action="{{ route('admin.teachers.add') }}" method="POST">
                @csrf
                ...
                <div style="display: flex; gap: 0.5rem; margin-top: 1rem;">
                    <button type="submit" class="btn btn-primary" style="flex-grow: 1; justify-content: center;">
                        <span id="btn-text">Register Teacher</span>
                    </button>
    ...
    <script>
        ...
        function openEditModal(teacher) {
            ...
            form.action = `/admin/teachers/${teacher.id}/edit`;
        }

        function resetForm() {
            panelTitle.innerHTML = '<i class="fa-solid fa-user-plus"></i> Add Teacher';
            btnText.innerText = 'Register Teacher';
            ...
            form.action = "{{ route('admin.teachers.add') }}";
        }
    </script>
@endsection