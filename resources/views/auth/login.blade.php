...
<head>
    ...
    <title>Login - TPA Teachers Performance Analysis</title>
    <!-- Favicon -->
    ...
    <div class="auth-container">
        ...
        <div class="auth-left">
            ...
            <div class="brand-description-wrapper">
                <h2 class="brand-subtitle">Welcome back</h2>
                <p class="brand-desc">
                    Access the TPA platform to monitor, evaluate, and enhance educational standards across all campuses.
                </p>
            </div>
        ...
        <div class="auth-right">
            <h2>Sign In</h2>
            <p class="form-subtitle">Enter your credentials to manage your account</p>
