...
<head>
    ...
    <title>Reset Password - TPA</title>
    <!-- Favicon -->
    ...
    <div class="auth-container">
        ...
        <div class="auth-left">
            ...
            <div class="brand-description-wrapper">
                <h2 class="brand-subtitle">Reset Password</h2>
                <p class="brand-desc">
                    Create a new, highly secure password to protect your account and regain access to the TPA platform.
                </p>
            </div>
        ...
        <div class="auth-right">
            <h2>New Password</h2>
            <p class="form-subtitle">Set your login credentials and verify your identity</p>
            ...
            <form action="{{ route('password.update') }}" method="POST">
                ...
                <div class="form-group">
                    <div class="input-wrapper">
                        <input class="form-input" style="padding-right: 2.75rem;" type="password" id="password"
                            name="password" placeholder="New Password" required autocomplete="new-password">
                        <label class="form-label" for="password">New Password</label>
                        <i class="fa-solid fa-eye input-icon-right" id="password-toggle"
                ...
                <div class="form-group">
                    <div class="input-wrapper">
                        <input class="form-input" style="padding-right: 2.75rem;" type="password"
                            id="password_confirmation" name="password_confirmation" placeholder="Confirm Password"
                            required autocomplete="new-password">
                        <label class="form-label" for="password_confirmation">Confirm Password</label>
                        <i class="fa-solid fa-eye input-icon-right" id="password-confirm-toggle"
